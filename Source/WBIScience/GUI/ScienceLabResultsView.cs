...
namespace WBIScience
{
    public class ScienceLabResultsView : Dialog<ScienceLabResultsView>
    {
        ...
        base(title, 600, 330)
        {
            ...
            {
                transmitIconWhite = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/WBITransmitWhite", false);
                transmitIconBlack = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/WBITransmit", false);

                transferIconWhite = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/WBIScienceWhite", false);
                transferIconBlack = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/WBIScience", false);

                scienceIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/WBIScienceWhite", false);
                repIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/WBIPublishWhite", false);
                fundsIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/WBISellWhite", false);
            }
        }
