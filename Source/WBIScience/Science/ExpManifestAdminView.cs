...
{
    internal class ExpManifestAdminView : Dialog<ExpManifestAdminView>
    {
        ...
        protected void setupIcons()
        {
            if (transferIcon == null)
                transferIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/TransferIcon", false);
            if (loadIcon == null)
                loadIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/SelectExpIcon", false);
            if (experimentIcon == null)
                experimentIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/ExperimentIcon", false);
            if (infoIcon == null)
                infoIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/infoIcon", false);
            if (completedIcon == null)
                completedIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/CompletedIcon", false);
            if (trashcanIcon == null)
                trashcanIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/TrashCan", false);
            if (playIcon == null)
                playIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/PlayIcon", false);
            if (pauseIcon == null)
                pauseIcon  = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/PauseIcon", false);
            if (transmitIcon == null)
                transmitIcon = GameDatabase.Instance.GetTexture("WildBlueIndustries/0WBIScience/Icons/WBITransmitWhite", false);
        }
